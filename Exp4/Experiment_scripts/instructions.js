...
var mainInstruction_part1 = [
                             ...
                             //////////////////////////////////// the third page //////////////////////////////////////////
                             '<p><div class = "InstrBx">In this example, you need to evaluate if the animal in the picture is either a young or old animal. As you can see in the previous picture, the animal shown in the upper image was a young\
...
var mainInstruction_part2 = [
                             ...
                             '<p><div class = "InstrBx">The task you just performed was a <b>\"regular\"</b> trial. In addition to regular trials, there will also be <b>\"transform\"</b> trials, where the task will change before the images appear on\
                              screen. Specifically, a new task cue will appear on the screen right before the images\' onset. In this case, you will need to perform the task based on the new cue instead of the original one.</p>' + 

                              '<p><b>Importantly, for the transform trials, ONLY the upper cue will be changed, with lower cue always unchanged</b></p>' +
...
var mainInstruction_part3 = [
                             //////////////////////////////////// the first page //////////////////////////////////////////
                             '<p><div class = "InstrBx">Now, you experienced both regular and transform trials. As you already saw, <b>in transform trials, a new cue will appear, and it will ONLY concern the upper cue, which means ONLY the upper cue will be a new one</b>. ' + 

                             '<p>The transform trials are more difficult than regular trials because they require you to quickly switch tasks. To better prepare for them, you can actually rely on the time interval between the original task cue and the images. \
                              <b>Specifically, the longer you have to wait following the task cue, the more likely the task will transform.</b></p>' +
