...
########################################################
# load(file = "D:/Ghent_Braem/Experiment/2nd_experiment/Experiment_rule_tran/result/bigdf.Rdata")
...
nrow(bigdf_clean_subject) - nrow(bigdf_ex_short_error_post) - 2472 - 4 # the number of excluded post-error trials
