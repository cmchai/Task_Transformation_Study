...
var mainInstruction_part2 = [
                             //////////////////////////////////// the first page //////////////////////////////////////////
                             '<p><div class = "InstrBx">The task you just performed was a <b>\"regular\"</b> trial. In addition to regular trials, there will also be trials that you do not need to respond to the task at all. we call them <b>\"omit\"</b> trials. \
                             In omit trials, there won\'t be any images shown after the cue. Instead, another pseudo cue will appear on the screen, implying that you will just skip this trial, and the next trial will immediately start</p>' + 
...
var mainInstruction_part3 = [
                             //////////////////////////////////// the first page //////////////////////////////////////////
                             '<p><div class = "InstrBx">Now, you experienced both regular and omit trials. </p>' +

                              '<p>In the experiment, there are six blocks. Three are blocks with <b>only</b> regular trials. The other three blocks will contain <b>both</b> regular and omit trials. \
                              In these blocks, the longer you have to wait following the first cue, the more likely it will be a omit trial.</div></p>',
                             //////////////////////////////////// the second page //////////////////////////////////////////
                              '<p><div class = "InstrBx"><b>Please respond as fast and accurate as possible! The participation credit will be awarded to you as long as you perform well enough.</b></p></div>', 
                             //////////////////////////////////// the third page //////////////////////////////////////////
