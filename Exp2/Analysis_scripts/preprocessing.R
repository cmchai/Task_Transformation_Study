...
ntrials <- 309 # number of trials for each subject
...
nrow(bigdf_clean_subject) - nrow(bigdf_ex_short_error_post) - 2134 - 4 # the number of excluded post-error trials
...
#######################################################################
### final step 2. implementing data exclusion for accuracy analysis ###
#######################################################################
